...
module.exports = function(app, passport){
	...
	app.get('/SleepInfo',isAuthenticated, function(req, res) {
	   res.render('template/SleepInfo', {});
	});
	...
	app.get('/heartrate',isAuthenticated, function(req, res) {
	   res.render('template/heartrate', {});
	});
	app.get('/bp',isAuthenticated, function(req, res) {
	   res.render('template/bp', {});
	});
	app.get('/steps',isAuthenticated, function(req, res) {
	   res.render('template/steps', {});
	});
	app.get('/Calories',isAuthenticated, function(req, res) {
	   res.render('template/Calories', {});
	});
